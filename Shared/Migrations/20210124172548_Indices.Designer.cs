...
namespace DataAccess.Migrations
{
    ...
    [Migration("20210124172548_Indices")]
            ...
            modelBuilder.Entity("DataAccess.Models.PriceIndex", b =>
                {
                    ...
                    b.HasIndex("ProductContentId")
                        .HasAnnotation("SqlServer:Clustered", false)
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "Index" });
            ...
            modelBuilder.Entity("DataAccess.Models.Product", b =>
                {
                    ...
                    b.HasIndex("UrlId")
                        .HasAnnotation("SqlServer:Clustered", false)
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "ImageId", "Name", "Hoplink", "Description", "MinPrice", "MaxPrice", "TotalReviews", "Rating", "OneStar", "TwoStars", "ThreeStars", "FourStars", "FiveStars", "UrlName" });

                    b.HasIndex("VendorId");

                    b.HasIndex("Name", "Id")
                        .HasAnnotation("SqlServer:Clustered", false)
                        .HasAnnotation("SqlServer:Include", new[] { "ImageId", "NicheId", "UrlId", "UrlName", "MinPrice", "MaxPrice", "TotalReviews", "Rating", "Date" });
            ...
            modelBuilder.Entity("DataAccess.Models.ProductContent", b =>
                {
                    ...
                    b.HasIndex("ProductId")
                        .HasAnnotation("SqlServer:Clustered", false)
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "IconId", "Name" });
            ...
            modelBuilder.Entity("DataAccess.Models.ProductPricePoint", b =>
                {
                    ...
                    b.HasIndex("ProductId")
                        .HasAnnotation("SqlServer:Clustered", false)
                        .HasAnnotation("SqlServer:Include", new[] { "Id", "TextBefore", "WholeNumber", "Decimal", "TextAfter", "Index" });
